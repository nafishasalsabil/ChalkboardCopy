...
public class All_Students_All_Records_Home_Tutor extends AppCompatActivity {
    private RecyclerView recyclerView;
    private All_Students_All_Attendance_Record_Home_TutorAdapter all_students_all_attendance_recordAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all__students__all__records__home__tutor);
        Intent intent = getIntent();
        String lec = intent.getStringExtra("lecture");
        String title = intent.getStringExtra("title");
        String section = intent.getStringExtra("section");
        asar_toolbar = findViewById(R.id.toolbar_asar_ht);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.all_attendance_record_recyclerview_ht);
                ...
                if(status.equals("Professional teacher / Home tutor")){
                    ...
                    collectionReference.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            ...
                            all_students_all_attendance_recordAdapter = new All_Students_All_Attendance_Record_Home_TutorAdapter(getApplicationContext(), studentItems);
