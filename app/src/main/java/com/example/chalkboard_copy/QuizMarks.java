            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(status.equals("Professional teacher / Home tutor")){
                    ...
                    quizcolllection = firestore.collection("users").document(userID)
                            ...
                            .document(title_course).collection("Sections").document(sec).collection("Quizes");
        ...
        floatingActionButton_quiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                quiz_date.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DatePickerDialog dialog = new DatePickerDialog(QuizMarks.this, new DatePickerDialog.OnDateSetListener() {
                            @Override
