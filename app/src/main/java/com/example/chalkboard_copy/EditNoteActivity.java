...
public class EditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println(title+""+section+""+note_name);

        ImageView imageBack = findViewById(R.id.ImageBack_update);
        ImageView imageSave = findViewById(R.id.ImageUpdate);
        ...
        inputNoteTitle = findViewById(R.id.inputNoteTitle_update);
        inputNoteSubtitle = findViewById(R.id.inputNoteSubtitle_update);
        inputNoteText = findViewById(R.id.inputNote_update);
        textDateTime = findViewById(R.id.textDateTime_update);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(status.equals("Professional teacher / Home tutor")){
                    ...
                    DocumentReference documentReference =  firestore.collection("users").document(userID)
                            ...
                            .document(title).collection("Sections").document(section).collection("MyNotes").document(note_name);
                    ...
                    DocumentReference documentReference =  firestore.collection("users").document(userID)
                            ...
                            .collection("Sections").document(section).collection("MyNotes").document(note_name);
                    documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @Override
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            NotesClass notesClass = documentSnapshot.toObject(NotesClass.class);
