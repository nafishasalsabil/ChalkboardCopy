...
public class EditNoteHomeTutorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_url = findViewById(R.id.image_url_ht);
        url_text = findViewById(R.id.url_textview_ht);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(status.equals("Professional teacher / Home tutor")){
                    ...
                    DocumentReference documentReference =  firestore.collection("users").document(userID)
                            ...
                            .document(title).collection("Batches").document(section).collection("MyNotes").document(note_name);
