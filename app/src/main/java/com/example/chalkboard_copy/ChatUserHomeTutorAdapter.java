...
class ChatUserHomeTutorAdapter extends RecyclerView.Adapter<ChatUserHomeTutorAdapter.ChatUserHomeTutorViewHolder> {
    ...
    public ChatUserHomeTutorAdapter(Context context, List<ChatUser> users, boolean isChat) {
        this.users = users;
    ...
    @NonNull
    @Override
    public ChatUserHomeTutorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.chats_user_item_hometutor, parent, false);
        return new ChatUserHomeTutorViewHolder(itemView, onItemClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull ChatUserHomeTutorViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,MessageActivityHomeTutor.class);
    ...
    public static class ChatUserHomeTutorViewHolder extends RecyclerView.ViewHolder {
        TextView chat_sername,last_message_textview;
        ImageView user_profile_pic,image_on,image_off;

        public ChatUserHomeTutorViewHolder(@NonNull View itemView, OnItemClickListener onItemClickListener) {
            super(itemView);
            chat_sername = itemView.findViewById(R.id.chat_username_ht);
            user_profile_pic = itemView.findViewById(R.id.user_image_ht);
            image_on = itemView.findViewById(R.id.image_on_ht);
            image_off = itemView.findViewById(R.id.image_off_ht);
            last_message_textview = itemView.findViewById(R.id.last_message_ht);
